...
const navMenus: INavbarProps["menus"] = [
  ...
  },
  {
    ...
    href: "#distributed-ledger",
  },
  {
    label: "Byzantine Generals",
    href: "#byzantine-generals",
  },
  {
    label: "Blockchain",
    href: "#blockchain",
...
const contentData: Array<IPropsVideoDescriptionPanel & { classId: string }> = [
  {
    classId: "home",
    videoData: {
    ...
    descriptionPanelData: {
      title: "An Educational Sandbox For Web3... And Much More.",
      points: [
      ...
      buttons: [
        <DescriptionPanelComponent.ButtonItem
    ...
    descriptionPanelData: {
      ...
      buttons: [
        <DescriptionPanelComponent.ButtonItem
          ...
          title="Build with a Hash Function"
          titleIcon="🔧"
          Button={PrimaryButton}
        />,
      ],
  ...
  },
  {
    ...
    videoData: {
      ...
      title: "Look Ahead: Transactions - ETH.BUILD",
    },
    descriptionPanelData: {
      title: "Look Ahead: Transactions",
      points: [
  ...
  },
  {
    ...
    videoData: {
      ...
      title: "Side Quest: Encryption - ETH.BUILD",
    },
    descriptionPanelData: {
      title: "Side Quest: Encryption",
      points: [
      ...
      buttons: [
        <DescriptionPanelComponent.ButtonItem
          href="https://www.youtube.com/embed/QJ010l-pBpE"
          title="Build"
          titleIcon="🔧"
          Button={TertiaryButton}
        />,
  ...
  {
    classId: "distributed-ledger",
    videoData: {
      src: "https://www.youtube.com/embed/z11wj9OcA4U",
      title: "Distributed Ledger - ETH.BUILD",
    },
    descriptionPanelData: {
  ...
  {
    classId: "byzantine-generals",
    videoData: {
      src: "https://www.youtube.com/embed/c7yvOlwBPoQ",
      title: "Byzantine Generals - ETH.BUILD",
    },
    descriptionPanelData: {
  ...
  {
    classId: "smart-contracts",
    videoData: {
      src: "https://www.youtube.com/embed/-6aYBdnJ-nM",
  ...
  return (
    <div className="bg-black">
      ...
      {contentData.map((itemData, index) => {
        return (
          <div key={index} id={itemData.classId}>
            <VideoDescriptionPanel {...itemData} reverse={index % 2 === 1} />
          </div>
        );
      })}
